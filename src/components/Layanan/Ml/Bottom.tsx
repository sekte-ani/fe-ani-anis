...
const points = [
	"Menyediakan solusi AI & Machine Learning berkualitas tinggi yang disesuaikan dengan kebutuhan bisnis Anda.",
	"Memberikan jawaban yang jelas dan cepat, siap untuk segera memulai pekerjaan.",
	"Model dikembangkan dengan teknologi terbaru dan siap di-deploy ke production.",
];
