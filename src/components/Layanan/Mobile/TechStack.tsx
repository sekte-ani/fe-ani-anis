...
const stacks = [
	{
		...
		items: ["React Native", "Flutter", "Expo", "Ionic"],
	},
	{
		icon: Apple,
	...
	},
	{
		icon: Server,
		title: "Backend & API",
		items: ["Node.js", "Laravel", "Firebase", "Supabase", "GraphQL"],
	},
	{
		icon: Bell,
		title: "Realtime & Notif",
		items: ["FCM", "OneSignal", "Socket.io", "Pusher"],
	},
	{
		icon: Wrench,
		title: "DevOps & Distribusi",
		items: ["Fastlane", "App Store Connect", "Play Console", "CodePush"],
	},
	{
		icon: Palette,
		title: "Design & QA",
		items: ["Figma", "Postman", "Detox", "Sentry"],
	},
];
			...
			<div className="max-w-7xl mx-auto w-full px-4 md:px-6">
				<div className="text-center mb-12" data-aos="fade-up">
					...
					<h2 className="text-3xl md:text-4xl font-bold text-greenfont1 mb-3">
						Tech Stack Mobile yang Kami Gunakan
					</h2>
					<p className="text-gray-600 max-w-2xl mx-auto">
						Stack modern untuk membangun aplikasi mobile yang cepat, stabil,
						dan siap dirilis ke App Store maupun Play Store.
					</p>
				</div>
