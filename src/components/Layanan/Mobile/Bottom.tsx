...
const points = [
	"Menyediakan berbagai solusi untuk menciptakan Mobile App berkualitas tinggi yang didukung strategi digital yang efektif.",
	"Memberikan jawaban yang jelas dan cepat, siap untuk segera memulai pekerjaan.",
	"Aplikasi dikembangkan dengan teknologi terbaru dan arsitektur yang scalable.",
];
