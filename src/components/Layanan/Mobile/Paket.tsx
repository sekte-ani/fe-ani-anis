...
const packages = [
	{
		name: "Basic",
		price: "Rp5.000.000",
		description: "Cocok untuk aplikasi sederhana dengan fitur inti.",
		features: [
			"Android app",
			"Hingga 5 screen",
			"Fitur dasar & login",
	...
	},
	{
		name: "Standard",
		price: "Rp12.000.000",
		description: "Aplikasi cross-platform dengan integrasi backend.",
		features: [
			"Android & iOS",
			"Hingga 15 screen",
	...
	},
	{
		name: "Premium",
		price: "Rp22.000.000",
		description: "Solusi mobile lengkap dengan backend dan admin panel.",
		features: [
			"Android & iOS",
			"Screen tak terbatas",
			"Backend & database",
		...
		<section className="py-12">
			...
			<div data-aos="fade-up" className="mb-10">
				...
				<p className="text-gray-600 max-w-xl">
					Pilih paket yang paling sesuai dengan kebutuhan dan skala bisnis Anda.
				</p>
			</div>
