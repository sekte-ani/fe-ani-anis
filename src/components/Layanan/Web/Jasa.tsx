			...
			<div className="max-w-7xl mx-auto w-full px-4 md:px-6">
				<div className="flex flex-col md:flex-row items-center gap-10">
					<div className="md:w-1/2 relative w-full h-72 md:h-[420px] rounded-2xl overflow-hidden shadow-xl">
						<Image
							src="/images/layanan/layanan-web.png"
							alt="Web Development"
							fill
					...
					<div className="md:w-1/2">
						...
						<p className="text-gray-600 leading-relaxed">
							Kami menyediakan layanan pengembangan website yang modern dan
							responsif untuk membantu bisnis Anda tampil profesional dan berkembang
							di dunia digital.
						</p>
						<p className="mt-4 text-gray-600 leading-relaxed">
							Dengan solusi lengkap mulai dari pembuatan website hingga pengelolaan
							konten, kami siap membantu bisnis Anda tumbuh lebih cepat dan efektif,
							mengoptimalkan setiap peluang online yang ada.
						</p>
					</div>
				</div>
			</div>
