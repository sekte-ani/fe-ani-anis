...
const types = [
	{
		...
		desc: "Website profesional untuk memperkenalkan bisnis, layanan, dan portofolio perusahaan Anda.",
	},
	{
		icon: ShoppingBag,
		title: "E-Commerce",
		desc: "Toko online lengkap dengan katalog produk, keranjang, dan integrasi payment gateway.",
	},
	{
		icon: Rocket,
		title: "Landing Page",
		desc: "Halaman tunggal yang dioptimasi untuk konversi, cocok untuk kampanye produk atau event.",
	},
	{
		icon: LayoutDashboard,
		title: "Web App & Dashboard",
		desc: "Aplikasi berbasis web custom dengan dashboard, manajemen data, dan role-based access.",
	},
	{
		icon: GraduationCap,
		title: "LMS & Edukasi",
		desc: "Platform pembelajaran online dengan modul, kuis, dan tracking progress siswa.",
	},
	{
		icon: Newspaper,
		title: "Portal Berita & Blog",
		desc: "Website berita atau blog dengan CMS yang mudah dikelola dan SEO-friendly.",
	},
];

export default function JenisWebsite() {
	useEffect(() => {
			...
			<div className="max-w-7xl mx-auto w-full px-4 md:px-6">
				<div className="text-center mb-12" data-aos="fade-up">
					...
					<p className="text-gray-600 max-w-2xl mx-auto">
						Berbagai macam tipe website dapat kami kerjakan sesuai dengan
