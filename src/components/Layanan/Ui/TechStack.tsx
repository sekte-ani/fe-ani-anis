...
const stacks = [
	{
		icon: Palette,
		title: "Design Tools",
		items: ["Figma", "Adobe XD", "Sketch", "Penpot"],
	},
	{
		icon: PenTool,
		title: "Visual & Asset",
		items: ["Illustrator", "Photoshop", "After Effects", "Lottie"],
	},
	{
		icon: Workflow,
		title: "Prototyping",
		items: ["Figma Prototype", "Protopie", "Framer", "Principle"],
	},
	{
		icon: Users,
		title: "User Research",
		items: ["Maze", "Lookback", "Hotjar", "Google Forms"],
	},
	{
		icon: FileSearch,
		title: "Collaboration",
		items: ["Miro", "FigJam", "Notion", "Slack"],
	},
	{
		icon: Sparkles,
		title: "Design System",
		items: ["Tokens Studio", "Storybook", "Zeroheight", "Figma Variables"],
	},
];
			...
			<div className="max-w-7xl mx-auto w-full px-4 md:px-6">
				<div className="text-center mb-12" data-aos="fade-up">
					...
					<p className="text-gray-600 max-w-2xl mx-auto">
						Kami memakai tools industri standar untuk setiap tahap, dari riset,
						desain, prototyping, hingga handoff ke developer.
					</p>
				</div>
