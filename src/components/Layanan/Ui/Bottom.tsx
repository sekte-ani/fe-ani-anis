...
const points = [
	"Menyediakan desain UI/UX berkualitas tinggi yang berfokus pada pengalaman pengguna dan estetika visual.",
	"Memberikan jawaban yang jelas dan cepat, siap untuk segera memulai pekerjaan.",
	"Desain dikembangkan berbasis riset dan usability testing untuk hasil yang optimal.",
];
