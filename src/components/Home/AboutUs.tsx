  ...
  return (
    ...
    >
      ...
      <div className="md:w-1/2 grid grid-cols-2 gap-4">
        <div
          className="col-span-2 h-80 md:h-96 relative rounded-2xl overflow-hidden shadow-xl"
          data-aos="fade-in"
        >
          <Image
        ...
        <div
          className="h-44 md:h-52 relative rounded-2xl overflow-hidden shadow-lg"
          data-aos="fade-up"
          data-aos-delay="100"
        >
          <Image
      ...
      <div className="md:w-1/2 flex flex-col md:px-8 justify-center gap-4">
        ...
        <p
          ...
          data-aos-delay="100"
        >
          Di A.N.I Solution, kami percaya bahwa bisnis kecil Indonesia berhak
          mendapatkan teknologi yang benar-benar dibuat untuk mereka. Kami hadir
          bukan sekadar sebagai penyedia solusi, tapi sebagai mitra yang tumbuh
          bersama bisnis yang kami layani.
        </p>
        <ul className="space-y-3" data-aos="fade-up" data-aos-delay="200">
          {[
            "Dibangun khusus untuk bisnis kecil dan menengah Indonesia",
            "Berorientasi pada kebutuhan pengguna yang nyata",
            "Solusi yang tumbuh bersama bisnis Anda",
          ].map((item) => (
        ...
        <p
          ...
          data-aos-delay="300"
        >
          Setiap bisnis di Indonesia berhak punya sistem yang dibuat untuk
          mereka. Kami mengundang Anda untuk tumbuh bersama kami menuju masa
          depan yang lebih baik.
        </p>
        <p
          className="font-bold text-greenfont2 text-lg"
          data-aos="fade-up"
          data-aos-delay="400"
        >
