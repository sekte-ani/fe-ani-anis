...
const services = [
  {
    ...
    description:
      "Website modern, responsif, dan berkinerja tinggi untuk bisnis Anda.",
  ...
  },
  {
    ...
    description:
      "Aplikasi mobile cross-platform yang powerful untuk Android & iOS.",
  ...
  },
  {
    name: "UI/UX Design",
    description:
      "Antarmuka yang intuitif dan pengalaman pengguna yang menyenangkan.",
  ...
  },
  {
    ...
    description:
      "Solusi cerdas berbasis AI untuk mengoptimalkan proses bisnis Anda.",
    href: "/layanan/mlai",
