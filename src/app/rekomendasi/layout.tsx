        ...
        <div>
          ...
          <div className="px-4 py-2">
            <p className="text-xs font-semibold text-slate-400 mb-4 px-2 uppercase tracking-wider">
              DISCOVERY FLOW
              <br />
              <span className="font-normal text-slate-400 capitalize lowercase">
                Process Steps
              </span>
            </p>
            <nav className="space-y-1">
              <NavItem
                href="/rekomendasi/home2"
              ...
              />
              <NavItem
                href="/rekomendasi/portofoli2"
                icon={<Layers size={18} />}
                label="Curate"
                active={false}
              />
              <NavItem
                href="/rekomendasi/final2"
                icon={<PenTool size={18} />}
                label="Refine"
                active={false}
              />
              <NavItem
                href="/rekomendasi/nyoba"
                icon={<PenTool size={18} />}
                label="Sudah Work"
                active={false}
              />
...
function NavItem({
  ...
  return (
    <Link
      href={href}
      className={`flex items-center gap-3 px-3 py-2.5 rounded-xl font-medium transition-colors ${active ? "bg-white text-blue-800 shadow-sm" : "text-slate-500 hover:bg-white/50 hover:text-blue-700"}`}
    >
